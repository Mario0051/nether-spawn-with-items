...
execute as @e[tag=height] at @s unless entity @r[tag=!nether] run setblock ~ ~ ~ minecraft:stone
execute as @e[tag=height] at @s unless entity @r[tag=!nether] unless block ~ ~ ~ minecraft:nether_portal run kill @s

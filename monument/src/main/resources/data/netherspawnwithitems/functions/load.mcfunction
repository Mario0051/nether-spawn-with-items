...
execute as @e[tag=height] if score @s du_data matches 0..8 run scoreboard players set $math.in_0 nswi_data 6
execute as @e[tag=height] if score @s du_data matches 9 run scoreboard players set $math.in_0 nswi_data 46
...
execute if score $math.in_0 nswi_data matches 46 run scoreboard players operation @e[tag=height] nswi_data %= $math.in_0 nswi_data
execute if score $math.in_0 nswi_data matches 6 run scoreboard players add @e[tag=height] nswi_data 7
execute if score $math.in_0 nswi_data matches 46 run scoreboard players add @e[tag=height] nswi_data 14
